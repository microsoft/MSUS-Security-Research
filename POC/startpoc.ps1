...
$poc_result2 = az deployment sub create --template-uri "$root/roleassignment.json" --parameters workspace_name=$workspace_name resourceGroup_name=$resourceGroup_name --location eastus
